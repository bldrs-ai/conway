...
| Was the M3 complexity worth it, and what to build next: the first production D3D load (geometry 90% / parse 8%), the added-lines vs shipped-gain ledger, why parse parallelism caps at 1.09× on D3D-shaped models, and the peak-heap wall at 9.8× file size that decides whether a 2–3 GB model opens at all | [design/new/load-performance-ledger.md](design/new/load-performance-ledger.md) |

...
export  class IfcPropertySet extends IfcPropertySetDefinition {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPROPERTYSET
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPropertySet.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPropertySet" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROPERTYSET ]

...
export  class IfcAnnotationFillArea extends IfcGeometricRepresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCANNOTATIONFILLAREA
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAnnotationFillArea.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAnnotationFillArea" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCANNOTATIONFILLAREA ]

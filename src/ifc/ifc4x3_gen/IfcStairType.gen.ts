...
export  class IfcStairType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTAIRTYPE
  }
  private PredefinedType_? : IfcStairTypeEnum

  public get PredefinedType() : IfcStairTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcStairTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStairType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStairType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTAIRTYPE ]

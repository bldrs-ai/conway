...
export  class IfcMotorConnection extends IfcEnergyConversionDevice {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMOTORCONNECTION
  }
  private PredefinedType_? : IfcMotorConnectionTypeEnum | null

  public get PredefinedType() : IfcMotorConnectionTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcMotorConnectionTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMotorConnection.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMotorConnection" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMOTORCONNECTION ]

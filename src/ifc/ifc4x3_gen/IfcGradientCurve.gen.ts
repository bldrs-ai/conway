...
export  class IfcGradientCurve extends IfcCompositeCurve {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCGRADIENTCURVE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcGradientCurve.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcGradientCurve" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCGRADIENTCURVE ]

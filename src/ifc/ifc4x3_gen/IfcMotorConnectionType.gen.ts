...
export  class IfcMotorConnectionType extends IfcEnergyConversionDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMOTORCONNECTIONTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMotorConnectionType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMotorConnectionType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMOTORCONNECTIONTYPE ]

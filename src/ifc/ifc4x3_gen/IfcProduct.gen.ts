...
export abstract class IfcProduct extends IfcObject {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPRODUCT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcProduct.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcProduct" )
      }

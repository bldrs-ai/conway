...
export  class IfcPropertyEnumeration extends IfcPropertyAbstraction {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPROPERTYENUMERATION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPropertyEnumeration.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPropertyEnumeration" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROPERTYENUMERATION ]

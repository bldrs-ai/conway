...
export  class IfcUnitaryControlElement extends IfcDistributionControlElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCUNITARYCONTROLELEMENT
  }
  ...
  public get PredefinedType() : IfcUnitaryControlElementTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 7, IfcUnitaryControlElementTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcUnitaryControlElement.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcUnitaryControlElement" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCUNITARYCONTROLELEMENT ]

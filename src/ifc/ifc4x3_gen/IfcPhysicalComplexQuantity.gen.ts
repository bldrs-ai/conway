...
export  class IfcPhysicalComplexQuantity extends IfcPhysicalQuantity {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPHYSICALCOMPLEXQUANTITY
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPhysicalComplexQuantity.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPhysicalComplexQuantity" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPHYSICALCOMPLEXQUANTITY ]

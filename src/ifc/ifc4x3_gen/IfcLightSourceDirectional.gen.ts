...
export  class IfcLightSourceDirectional extends IfcLightSource {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCLIGHTSOURCEDIRECTIONAL
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcLightSourceDirectional.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcLightSourceDirectional" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCLIGHTSOURCEDIRECTIONAL ]

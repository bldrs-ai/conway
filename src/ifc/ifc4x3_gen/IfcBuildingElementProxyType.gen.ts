...
export  class IfcBuildingElementProxyType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBUILDINGELEMENTPROXYTYPE
  }
  private PredefinedType_? : IfcBuildingElementProxyTypeEnum

  public get PredefinedType() : IfcBuildingElementProxyTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcBuildingElementProxyTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBuildingElementProxyType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBuildingElementProxyType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBUILDINGELEMENTPROXYTYPE ]

...
export  class IfcActuatorType extends IfcDistributionControlElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCACTUATORTYPE
  }
  private PredefinedType_? : IfcActuatorTypeEnum

  public get PredefinedType() : IfcActuatorTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 7, IfcActuatorTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcActuatorType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcActuatorType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCACTUATORTYPE ]

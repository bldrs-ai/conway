...
export  class IfcStructuralLoadSingleForceWarping extends IfcStructuralLoadSingleForce {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTRUCTURALLOADSINGLEFORCEWARPING
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStructuralLoadSingleForceWarping.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStructuralLoadSingleForceWarping" )
      }

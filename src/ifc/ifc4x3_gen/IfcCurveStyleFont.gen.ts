...
export  class IfcCurveStyleFont extends IfcPresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCURVESTYLEFONT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCurveStyleFont.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCurveStyleFont" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCURVESTYLEFONT ]

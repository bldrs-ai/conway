...
export  class IfcApprovalRelationship extends IfcResourceLevelRelationship {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCAPPROVALRELATIONSHIP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcApprovalRelationship.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcApprovalRelationship" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAPPROVALRELATIONSHIP ]

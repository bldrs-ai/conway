...
export  class IfcShadingDevice extends IfcBuiltElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSHADINGDEVICE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcShadingDevice.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcShadingDevice" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSHADINGDEVICE ]

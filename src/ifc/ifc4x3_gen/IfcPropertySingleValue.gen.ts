...
export  class IfcPropertySingleValue extends IfcSimpleProperty {
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPropertySingleValue.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPropertySingleValue" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROPERTYSINGLEVALUE ]

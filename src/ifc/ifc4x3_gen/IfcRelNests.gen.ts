...
export  class IfcRelNests extends IfcRelDecomposes {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELNESTS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelNests.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelNests" )
      }

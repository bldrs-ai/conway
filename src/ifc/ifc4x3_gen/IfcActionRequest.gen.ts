...
export  class IfcActionRequest extends IfcControl {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCACTIONREQUEST
  }
  ...
  public get PredefinedType() : IfcActionRequestTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 6, 6, 4, IfcActionRequestTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcActionRequest.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcActionRequest" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCACTIONREQUEST ]

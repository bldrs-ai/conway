...
export  class IfcRegularTimeSeries extends IfcTimeSeries {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCREGULARTIMESERIES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRegularTimeSeries.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRegularTimeSeries" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCREGULARTIMESERIES ]

...
export  class IfcCableCarrierFitting extends IfcFlowFitting {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCABLECARRIERFITTING
  }
  ...
  public get PredefinedType() : IfcCableCarrierFittingTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcCableCarrierFittingTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCableCarrierFitting.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCableCarrierFitting" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCABLECARRIERFITTING ]

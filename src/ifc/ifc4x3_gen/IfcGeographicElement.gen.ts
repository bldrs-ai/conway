...
export  class IfcGeographicElement extends IfcElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCGEOGRAPHICELEMENT
  }
  ...
  public get PredefinedType() : IfcGeographicElementTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 5, IfcGeographicElementTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcGeographicElement.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcGeographicElement" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCGEOGRAPHICELEMENT ]

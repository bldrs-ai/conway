...
export  class IfcCompositeProfileDef extends IfcProfileDef {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCOMPOSITEPROFILEDEF
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCompositeProfileDef.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCompositeProfileDef" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCOMPOSITEPROFILEDEF ]

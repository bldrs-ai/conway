...
export  class IfcShadingDeviceType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSHADINGDEVICETYPE
  }
  private PredefinedType_? : IfcShadingDeviceTypeEnum

  public get PredefinedType() : IfcShadingDeviceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcShadingDeviceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcShadingDeviceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcShadingDeviceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSHADINGDEVICETYPE ]

...
export  class IfcSurfaceOfLinearExtrusion extends IfcSweptSurface {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSURFACEOFLINEAREXTRUSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSurfaceOfLinearExtrusion.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSurfaceOfLinearExtrusion" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSURFACEOFLINEAREXTRUSION ]

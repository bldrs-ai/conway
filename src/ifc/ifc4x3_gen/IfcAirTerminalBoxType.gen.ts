...
export  class IfcAirTerminalBoxType extends IfcFlowControllerType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCAIRTERMINALBOXTYPE
  }
  private PredefinedType_? : IfcAirTerminalBoxTypeEnum

  public get PredefinedType() : IfcAirTerminalBoxTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcAirTerminalBoxTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAirTerminalBoxType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAirTerminalBoxType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAIRTERMINALBOXTYPE ]

...
export  class IfcDistributionChamberElementType extends IfcDistributionFlowElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDISTRIBUTIONCHAMBERELEMENTTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDistributionChamberElementType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDistributionChamberElementType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDISTRIBUTIONCHAMBERELEMENTTYPE ]

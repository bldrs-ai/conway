...
export  class IfcElectricFlowStorageDeviceType extends IfcFlowStorageDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELECTRICFLOWSTORAGEDEVICETYPE
  }
  ...
  public get PredefinedType() : IfcElectricFlowStorageDeviceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcElectricFlowStorageDeviceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcElectricFlowStorageDeviceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcElectricFlowStorageDeviceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCELECTRICFLOWSTORAGEDEVICETYPE ]

...
export  class IfcAudioVisualAppliance extends IfcFlowTerminal {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCAUDIOVISUALAPPLIANCE
  }
  ...
  public get PredefinedType() : IfcAudioVisualApplianceTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcAudioVisualApplianceTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAudioVisualAppliance.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAudioVisualAppliance" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAUDIOVISUALAPPLIANCE ]

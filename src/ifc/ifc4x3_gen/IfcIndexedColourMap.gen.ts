...
export  class IfcIndexedColourMap extends IfcPresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCINDEXEDCOLOURMAP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcIndexedColourMap.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcIndexedColourMap" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCINDEXEDCOLOURMAP ]

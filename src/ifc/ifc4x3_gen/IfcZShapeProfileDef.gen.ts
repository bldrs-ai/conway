...
export  class IfcZShapeProfileDef extends IfcParameterizedProfileDef {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCZSHAPEPROFILEDEF
  }
  ...
  public get EdgeRadius() : number | null {
    if ( this.EdgeRadius_ === void 0 ) {
      this.EdgeRadius_ = this.extractNumber( 8, 3, 2, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcZShapeProfileDef.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcZShapeProfileDef" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCZSHAPEPROFILEDEF ]

...
export  class IfcTubeBundleType extends IfcEnergyConversionDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTUBEBUNDLETYPE
  }
  private PredefinedType_? : IfcTubeBundleTypeEnum

  public get PredefinedType() : IfcTubeBundleTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcTubeBundleTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTubeBundleType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTubeBundleType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTUBEBUNDLETYPE ]

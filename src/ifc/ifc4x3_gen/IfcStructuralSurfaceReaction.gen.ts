...
export  class IfcStructuralSurfaceReaction extends IfcStructuralReaction {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTRUCTURALSURFACEREACTION
  }
  ...
  public get PredefinedType() : IfcStructuralSurfaceActivityTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcStructuralSurfaceActivityTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStructuralSurfaceReaction.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStructuralSurfaceReaction" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTRUCTURALSURFACEREACTION ]

...
export  class IfcEngineType extends IfcEnergyConversionDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCENGINETYPE
  }
  private PredefinedType_? : IfcEngineTypeEnum

  public get PredefinedType() : IfcEngineTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcEngineTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcEngineType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcEngineType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCENGINETYPE ]

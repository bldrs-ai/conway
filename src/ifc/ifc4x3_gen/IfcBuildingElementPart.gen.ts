...
export  class IfcBuildingElementPart extends IfcElementComponent {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBUILDINGELEMENTPART
  }
  ...
  public get PredefinedType() : IfcBuildingElementPartTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcBuildingElementPartTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBuildingElementPart.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBuildingElementPart" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBUILDINGELEMENTPART ]

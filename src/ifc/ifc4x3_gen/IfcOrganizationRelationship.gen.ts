...
export  class IfcOrganizationRelationship extends IfcResourceLevelRelationship {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCORGANIZATIONRELATIONSHIP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcOrganizationRelationship.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcOrganizationRelationship" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCORGANIZATIONRELATIONSHIP ]

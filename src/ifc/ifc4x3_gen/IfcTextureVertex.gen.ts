...
export  class IfcTextureVertex extends IfcPresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTEXTUREVERTEX
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTextureVertex.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTextureVertex" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTEXTUREVERTEX ]

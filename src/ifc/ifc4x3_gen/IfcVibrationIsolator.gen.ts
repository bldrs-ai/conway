...
export  class IfcVibrationIsolator extends IfcElementComponent {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCVIBRATIONISOLATOR
  }
  ...
  public get PredefinedType() : IfcVibrationIsolatorTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcVibrationIsolatorTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcVibrationIsolator.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcVibrationIsolator" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCVIBRATIONISOLATOR ]

...
export  class IfcHumidifier extends IfcEnergyConversionDevice {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCHUMIDIFIER
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcHumidifier.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcHumidifier" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCHUMIDIFIER ]

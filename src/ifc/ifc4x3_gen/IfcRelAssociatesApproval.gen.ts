...
export  class IfcRelAssociatesApproval extends IfcRelAssociates {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELASSOCIATESAPPROVAL
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelAssociatesApproval.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelAssociatesApproval" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELASSOCIATESAPPROVAL ]

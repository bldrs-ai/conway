...
export  class IfcElectricGenerator extends IfcEnergyConversionDevice {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELECTRICGENERATOR
  }
  ...
  public get PredefinedType() : IfcElectricGeneratorTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcElectricGeneratorTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcElectricGenerator.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcElectricGenerator" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCELECTRICGENERATOR ]

...
export  class IfcRelAssignsToControl extends IfcRelAssigns {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELASSIGNSTOCONTROL
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelAssignsToControl.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelAssignsToControl" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELASSIGNSTOCONTROL ]

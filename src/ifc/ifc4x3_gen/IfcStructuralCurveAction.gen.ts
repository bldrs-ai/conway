...
export  class IfcStructuralCurveAction extends IfcStructuralAction {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTRUCTURALCURVEACTION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStructuralCurveAction.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStructuralCurveAction" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTRUCTURALCURVEACTION, EntityTypesIfc4x3.IFCSTRUCTURALLINEARACTION ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCSTRUCTURALCURVEACTION
}

...
export  class IfcMaterialProperties extends IfcExtendedProperties {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMATERIALPROPERTIES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMaterialProperties.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMaterialProperties" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMATERIALPROPERTIES ]

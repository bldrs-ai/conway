...
export abstract class IfcConstructionResource extends IfcResource {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONSTRUCTIONRESOURCE
  }
  ...
  public get Usage() : IfcResourceTime | null {
    if ( this.Usage_ === void 0 ) {
      this.Usage_ = this.extractElement( 7, 7, 4, true, IfcResourceTime )
    }
  ...
  public get BaseQuantity() : IfcPhysicalQuantity | null {
    if ( this.BaseQuantity_ === void 0 ) {
      this.BaseQuantity_ = this.extractElement( 9, 7, 4, true, IfcPhysicalQuantity )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcConstructionResource.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcConstructionResource" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONSTRUCTIONEQUIPMENTRESOURCE, EntityTypesIfc4x3.IFCCONSTRUCTIONMATERIALRESOURCE, EntityTypesIfc4x3.IFCCONSTRUCTIONPRODUCTRESOURCE, EntityTypesIfc4x3.IFCCREWRESOURCE, EntityTypesIfc4x3.IFCLABORRESOURCE, EntityTypesIfc4x3.IFCSUBCONTRACTRESOURCE ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCCONSTRUCTIONRESOURCE
}

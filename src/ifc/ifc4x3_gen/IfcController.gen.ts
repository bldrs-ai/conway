...
export  class IfcController extends IfcDistributionControlElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONTROLLER
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcController.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcController" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONTROLLER ]

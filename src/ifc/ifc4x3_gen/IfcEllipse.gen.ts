...
export  class IfcEllipse extends IfcConic {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELLIPSE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcEllipse.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcEllipse" )
      }

...
///**
// *  */
export  class IfcRecurrencePattern extends StepEntityBase< EntityTypesIfc4x3 > {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRECURRENCEPATTERN
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRecurrencePattern.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRecurrencePattern" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRECURRENCEPATTERN ]

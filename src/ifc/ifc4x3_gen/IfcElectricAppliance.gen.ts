...
export  class IfcElectricAppliance extends IfcFlowTerminal {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELECTRICAPPLIANCE
  }
  ...
  public get PredefinedType() : IfcElectricApplianceTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcElectricApplianceTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcElectricAppliance.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcElectricAppliance" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCELECTRICAPPLIANCE ]

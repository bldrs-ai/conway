...
export  class IfcOutletType extends IfcFlowTerminalType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCOUTLETTYPE
  }
  private PredefinedType_? : IfcOutletTypeEnum

  public get PredefinedType() : IfcOutletTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcOutletTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcOutletType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcOutletType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCOUTLETTYPE ]

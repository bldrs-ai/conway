...
export  class IfcElementAssemblyType extends IfcElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELEMENTASSEMBLYTYPE
  }
  private PredefinedType_? : IfcElementAssemblyTypeEnum

  public get PredefinedType() : IfcElementAssemblyTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 5, IfcElementAssemblyTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcElementAssemblyType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcElementAssemblyType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCELEMENTASSEMBLYTYPE ]

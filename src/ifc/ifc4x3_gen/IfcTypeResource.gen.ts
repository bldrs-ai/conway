...
export abstract class IfcTypeResource extends IfcTypeObject {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTYPERESOURCE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTypeResource.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTypeResource" )
      }
  ...
  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCTYPERESOURCE
}

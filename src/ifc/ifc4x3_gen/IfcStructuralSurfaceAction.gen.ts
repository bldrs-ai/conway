...
export  class IfcStructuralSurfaceAction extends IfcStructuralAction {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTRUCTURALSURFACEACTION
  }
  ...
  public get PredefinedType() : IfcStructuralSurfaceActivityTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 11, 10, 6, IfcStructuralSurfaceActivityTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStructuralSurfaceAction.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStructuralSurfaceAction" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTRUCTURALSURFACEACTION, EntityTypesIfc4x3.IFCSTRUCTURALPLANARACTION ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCSTRUCTURALSURFACEACTION
}

...
export  class IfcPlanarBox extends IfcPlanarExtent {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPLANARBOX
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPlanarBox.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPlanarBox" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPLANARBOX ]

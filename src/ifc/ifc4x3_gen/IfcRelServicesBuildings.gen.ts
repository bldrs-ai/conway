...
export  class IfcRelServicesBuildings extends IfcRelConnects {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELSERVICESBUILDINGS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelServicesBuildings.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelServicesBuildings" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELSERVICESBUILDINGS ]

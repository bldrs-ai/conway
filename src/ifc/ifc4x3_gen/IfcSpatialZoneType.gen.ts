...
export  class IfcSpatialZoneType extends IfcSpatialElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSPATIALZONETYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSpatialZoneType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSpatialZoneType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSPATIALZONETYPE ]

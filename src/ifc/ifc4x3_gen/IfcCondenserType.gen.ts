...
export  class IfcCondenserType extends IfcEnergyConversionDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONDENSERTYPE
  }
  private PredefinedType_? : IfcCondenserTypeEnum

  public get PredefinedType() : IfcCondenserTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcCondenserTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCondenserType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCondenserType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONDENSERTYPE ]

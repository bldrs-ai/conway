...
export  class IfcStructuralLoadSingleDisplacementDistortion extends IfcStructuralLoadSingleDisplacement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTRUCTURALLOADSINGLEDISPLACEMENTDISTORTION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStructuralLoadSingleDisplacementDistortion.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStructuralLoadSingleDisplacementDistortion" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTRUCTURALLOADSINGLEDISPLACEMENTDISTORTION ]

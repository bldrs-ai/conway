...
export  class IfcDiscreteAccessoryType extends IfcElementComponentType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDISCRETEACCESSORYTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDiscreteAccessoryType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDiscreteAccessoryType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDISCRETEACCESSORYTYPE ]

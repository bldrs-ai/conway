...
export  class IfcElectricTimeControlType extends IfcFlowControllerType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELECTRICTIMECONTROLTYPE
  }
  private PredefinedType_? : IfcElectricTimeControlTypeEnum

  public get PredefinedType() : IfcElectricTimeControlTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcElectricTimeControlTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcElectricTimeControlType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcElectricTimeControlType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCELECTRICTIMECONTROLTYPE ]

...
export  class IfcRelDefinesByTemplate extends IfcRelDefines {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELDEFINESBYTEMPLATE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelDefinesByTemplate.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelDefinesByTemplate" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELDEFINESBYTEMPLATE ]

...
export  class IfcSpaceHeater extends IfcFlowTerminal {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSPACEHEATER
  }
  private PredefinedType_? : IfcSpaceHeaterTypeEnum | null

  public get PredefinedType() : IfcSpaceHeaterTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcSpaceHeaterTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSpaceHeater.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSpaceHeater" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSPACEHEATER ]

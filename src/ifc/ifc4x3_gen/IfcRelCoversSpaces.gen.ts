...
export  class IfcRelCoversSpaces extends IfcRelConnects {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELCOVERSSPACES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelCoversSpaces.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelCoversSpaces" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELCOVERSSPACES ]

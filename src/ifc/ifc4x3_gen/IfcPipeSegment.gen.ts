...
export  class IfcPipeSegment extends IfcFlowSegment {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPIPESEGMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPipeSegment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPipeSegment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPIPESEGMENT ]

...
export  class IfcCartesianPointList3D extends IfcCartesianPointList {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCARTESIANPOINTLIST3D
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCartesianPointList3D.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCartesianPointList3D" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCARTESIANPOINTLIST3D ]

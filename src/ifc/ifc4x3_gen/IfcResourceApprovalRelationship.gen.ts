...
export  class IfcResourceApprovalRelationship extends IfcResourceLevelRelationship {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRESOURCEAPPROVALRELATIONSHIP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcResourceApprovalRelationship.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcResourceApprovalRelationship" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRESOURCEAPPROVALRELATIONSHIP ]

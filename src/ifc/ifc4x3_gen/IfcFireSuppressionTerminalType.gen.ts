...
export  class IfcFireSuppressionTerminalType extends IfcFlowTerminalType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFIRESUPPRESSIONTERMINALTYPE
  }
  ...
  public get PredefinedType() : IfcFireSuppressionTerminalTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcFireSuppressionTerminalTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFireSuppressionTerminalType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFireSuppressionTerminalType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFIRESUPPRESSIONTERMINALTYPE ]

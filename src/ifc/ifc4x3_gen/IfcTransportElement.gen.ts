...
export  class IfcTransportElement extends IfcTransportationDevice {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTRANSPORTELEMENT
  }
  private PredefinedType_? : IfcTransportElementTypeEnum | null

  public get PredefinedType() : IfcTransportElementTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcTransportElementTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTransportElement.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTransportElement" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTRANSPORTELEMENT ]

...
export  class IfcCurtainWallType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCURTAINWALLTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCurtainWallType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCurtainWallType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCURTAINWALLTYPE ]

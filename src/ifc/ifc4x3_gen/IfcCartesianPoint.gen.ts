...
export  class IfcCartesianPoint extends IfcPoint {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCARTESIANPOINT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCartesianPoint.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCartesianPoint" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCARTESIANPOINT ]

...
export  class IfcFace extends IfcTopologicalRepresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFACE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFace.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFace" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFACE, EntityTypesIfc4x3.IFCFACESURFACE, EntityTypesIfc4x3.IFCADVANCEDFACE ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCFACE
}

...
export abstract class IfcSweptAreaSolid extends IfcSolidModel {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSWEPTAREASOLID
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSweptAreaSolid.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSweptAreaSolid" )
      }

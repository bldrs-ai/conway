...
export  class IfcExternalReferenceRelationship extends IfcResourceLevelRelationship {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCEXTERNALREFERENCERELATIONSHIP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcExternalReferenceRelationship.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcExternalReferenceRelationship" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCEXTERNALREFERENCERELATIONSHIP ]

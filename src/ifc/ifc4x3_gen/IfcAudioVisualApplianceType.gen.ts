...
export  class IfcAudioVisualApplianceType extends IfcFlowTerminalType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCAUDIOVISUALAPPLIANCETYPE
  }
  private PredefinedType_? : IfcAudioVisualApplianceTypeEnum

  public get PredefinedType() : IfcAudioVisualApplianceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcAudioVisualApplianceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAudioVisualApplianceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAudioVisualApplianceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAUDIOVISUALAPPLIANCETYPE ]

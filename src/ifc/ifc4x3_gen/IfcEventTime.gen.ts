...
export  class IfcEventTime extends IfcSchedulingTime {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCEVENTTIME
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcEventTime.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcEventTime" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCEVENTTIME ]

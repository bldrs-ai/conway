...
export  class IfcColourRgbList extends IfcPresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCOLOURRGBLIST
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcColourRgbList.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcColourRgbList" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCOLOURRGBLIST ]

...
export  class IfcDistributionChamberElement extends IfcDistributionFlowElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDISTRIBUTIONCHAMBERELEMENT
  }
  ...
  public get PredefinedType() : IfcDistributionChamberElementTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 7, IfcDistributionChamberElementTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDistributionChamberElement.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDistributionChamberElement" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDISTRIBUTIONCHAMBERELEMENT ]

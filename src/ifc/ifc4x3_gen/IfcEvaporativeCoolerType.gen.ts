...
export  class IfcEvaporativeCoolerType extends IfcEnergyConversionDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCEVAPORATIVECOOLERTYPE
  }
  private PredefinedType_? : IfcEvaporativeCoolerTypeEnum

  public get PredefinedType() : IfcEvaporativeCoolerTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcEvaporativeCoolerTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcEvaporativeCoolerType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcEvaporativeCoolerType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCEVAPORATIVECOOLERTYPE ]

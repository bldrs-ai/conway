...
export  class IfcSurfaceStyle extends IfcPresentationStyle {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSURFACESTYLE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSurfaceStyle.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSurfaceStyle" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSURFACESTYLE ]

...
export abstract class IfcResource extends IfcObject {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRESOURCE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcResource.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcResource" )
      }

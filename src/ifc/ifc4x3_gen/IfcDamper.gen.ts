...
export  class IfcDamper extends IfcFlowController {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDAMPER
  }
  private PredefinedType_? : IfcDamperTypeEnum | null

  public get PredefinedType() : IfcDamperTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcDamperTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDamper.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDamper" )
      }

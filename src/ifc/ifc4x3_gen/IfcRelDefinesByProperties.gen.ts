...
export  class IfcRelDefinesByProperties extends IfcRelDefines {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELDEFINESBYPROPERTIES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelDefinesByProperties.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelDefinesByProperties" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELDEFINESBYPROPERTIES ]

...
export  class IfcColumnType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCOLUMNTYPE
  }
  private PredefinedType_? : IfcColumnTypeEnum

  public get PredefinedType() : IfcColumnTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcColumnTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcColumnType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcColumnType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCOLUMNTYPE ]

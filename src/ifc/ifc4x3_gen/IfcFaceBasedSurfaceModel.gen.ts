...
export  class IfcFaceBasedSurfaceModel extends IfcGeometricRepresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFACEBASEDSURFACEMODEL
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFaceBasedSurfaceModel.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFaceBasedSurfaceModel" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFACEBASEDSURFACEMODEL ]

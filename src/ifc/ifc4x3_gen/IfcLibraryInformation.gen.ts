...
export  class IfcLibraryInformation extends IfcExternalInformation {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCLIBRARYINFORMATION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcLibraryInformation.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcLibraryInformation" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCLIBRARYINFORMATION ]

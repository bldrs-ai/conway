...
export  class IfcRightCircularCylinder extends IfcCsgPrimitive3D {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRIGHTCIRCULARCYLINDER
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRightCircularCylinder.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRightCircularCylinder" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRIGHTCIRCULARCYLINDER ]

...
export  class IfcElectricTimeControl extends IfcFlowController {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCELECTRICTIMECONTROL
  }
  ...
  public get PredefinedType() : IfcElectricTimeControlTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcElectricTimeControlTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcElectricTimeControl.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcElectricTimeControl" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCELECTRICTIMECONTROL ]

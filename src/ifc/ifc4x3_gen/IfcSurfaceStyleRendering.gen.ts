...
export  class IfcSurfaceStyleRendering extends IfcSurfaceStyleShading {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSURFACESTYLERENDERING
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSurfaceStyleRendering.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSurfaceStyleRendering" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSURFACESTYLERENDERING ]

...
export  class IfcChimneyType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCHIMNEYTYPE
  }
  private PredefinedType_? : IfcChimneyTypeEnum

  public get PredefinedType() : IfcChimneyTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcChimneyTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcChimneyType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcChimneyType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCHIMNEYTYPE ]

...
export  class IfcEdgeLoop extends IfcLoop {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCEDGELOOP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcEdgeLoop.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcEdgeLoop" )
      }

...
export  class IfcDuctSilencer extends IfcFlowTreatmentDevice {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDUCTSILENCER
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDuctSilencer.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDuctSilencer" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDUCTSILENCER ]

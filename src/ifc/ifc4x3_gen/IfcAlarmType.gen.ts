...
export  class IfcAlarmType extends IfcDistributionControlElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCALARMTYPE
  }
  private PredefinedType_? : IfcAlarmTypeEnum

  public get PredefinedType() : IfcAlarmTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 7, IfcAlarmTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAlarmType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAlarmType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCALARMTYPE ]

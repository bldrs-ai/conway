...
export  class IfcImageTexture extends IfcSurfaceTexture {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCIMAGETEXTURE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcImageTexture.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcImageTexture" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCIMAGETEXTURE ]

...
export  class IfcConstructionProductResourceType extends IfcConstructionResourceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONSTRUCTIONPRODUCTRESOURCETYPE
  }
  ...
  public get PredefinedType() : IfcConstructionProductResourceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 11, 11, 5, IfcConstructionProductResourceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcConstructionProductResourceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcConstructionProductResourceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONSTRUCTIONPRODUCTRESOURCETYPE ]

...
export  class IfcBuildingStorey extends IfcSpatialStructureElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBUILDINGSTOREY
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBuildingStorey.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBuildingStorey" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBUILDINGSTOREY ]

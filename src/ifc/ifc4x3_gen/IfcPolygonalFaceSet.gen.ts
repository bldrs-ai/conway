...
export  class IfcPolygonalFaceSet extends IfcTessellatedFaceSet {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPOLYGONALFACESET
  }
  ...
  public get Closed() : boolean | null {
    if ( this.Closed_ === void 0 ) {
      this.Closed_ = this.extractBoolean( 1, 1, 4, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPolygonalFaceSet.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPolygonalFaceSet" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPOLYGONALFACESET ]

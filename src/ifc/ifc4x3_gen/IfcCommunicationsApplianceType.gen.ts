...
export  class IfcCommunicationsApplianceType extends IfcFlowTerminalType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCOMMUNICATIONSAPPLIANCETYPE
  }
  ...
  public get PredefinedType() : IfcCommunicationsApplianceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcCommunicationsApplianceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCommunicationsApplianceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCommunicationsApplianceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCOMMUNICATIONSAPPLIANCETYPE ]

...
export  class IfcTriangulatedFaceSet extends IfcTessellatedFaceSet {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTRIANGULATEDFACESET
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTriangulatedFaceSet.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTriangulatedFaceSet" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTRIANGULATEDFACESET, EntityTypesIfc4x3.IFCTRIANGULATEDIRREGULARNETWORK ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCTRIANGULATEDFACESET
}

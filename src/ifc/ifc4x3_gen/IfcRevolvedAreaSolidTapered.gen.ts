...
export  class IfcRevolvedAreaSolidTapered extends IfcRevolvedAreaSolid {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCREVOLVEDAREASOLIDTAPERED
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRevolvedAreaSolidTapered.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRevolvedAreaSolidTapered" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCREVOLVEDAREASOLIDTAPERED ]

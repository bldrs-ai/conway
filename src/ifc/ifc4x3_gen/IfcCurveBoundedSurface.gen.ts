...
export  class IfcCurveBoundedSurface extends IfcBoundedSurface {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCURVEBOUNDEDSURFACE
  }
  ...
  public get ImplicitOuter() : boolean {
    if ( this.ImplicitOuter_ === void 0 ) {
      this.ImplicitOuter_ = this.extractBoolean( 2, 0, 4, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCurveBoundedSurface.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCurveBoundedSurface" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCURVEBOUNDEDSURFACE ]

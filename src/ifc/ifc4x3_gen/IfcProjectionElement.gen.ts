...
export  class IfcProjectionElement extends IfcFeatureElementAddition {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPROJECTIONELEMENT
  }
  ...
  public get PredefinedType() : IfcProjectionElementTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 7, IfcProjectionElementTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcProjectionElement.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcProjectionElement" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROJECTIONELEMENT ]

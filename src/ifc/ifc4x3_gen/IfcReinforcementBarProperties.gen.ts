...
export  class IfcReinforcementBarProperties extends IfcPreDefinedProperties {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCREINFORCEMENTBARPROPERTIES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcReinforcementBarProperties.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcReinforcementBarProperties" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCREINFORCEMENTBARPROPERTIES ]

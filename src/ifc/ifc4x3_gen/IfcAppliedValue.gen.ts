...
import { IfcArithmeticOperatorEnum, IfcArithmeticOperatorEnumDeserializeStep } from "./index"
import {
  stepExtractOptional,
...
export  class IfcAppliedValue extends StepEntityBase< EntityTypesIfc4x3 > {
  ...
  public get Components() : Array<IfcAppliedValue> | null {
    if ( this.Components_ === void 0 ) {
      ...
      this.Components_ = value
    }

    return this.Components_ as Array<IfcAppliedValue> | null
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAppliedValue.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAppliedValue" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAPPLIEDVALUE, EntityTypesIfc4x3.IFCCOSTVALUE ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCAPPLIEDVALUE
}

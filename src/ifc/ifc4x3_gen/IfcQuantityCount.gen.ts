...
export  class IfcQuantityCount extends IfcPhysicalSimpleQuantity {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCQUANTITYCOUNT
  }
  ...
  public get CountValue() : number {
    if ( this.CountValue_ === void 0 ) {
      this.CountValue_ = this.extractNumber( 3, 3, 2, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcQuantityCount.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcQuantityCount" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCQUANTITYCOUNT ]

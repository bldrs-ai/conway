...
export  class IfcSurfaceReinforcementArea extends IfcStructuralLoadOrResult {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSURFACEREINFORCEMENTAREA
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSurfaceReinforcementArea.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSurfaceReinforcementArea" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSURFACEREINFORCEMENTAREA ]

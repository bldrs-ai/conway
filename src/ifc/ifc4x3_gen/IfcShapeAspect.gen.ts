...
///**
// *  */
export  class IfcShapeAspect extends StepEntityBase< EntityTypesIfc4x3 > {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSHAPEASPECT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcShapeAspect.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcShapeAspect" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSHAPEASPECT ]

...
export  class IfcDocumentInformation extends IfcExternalInformation {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDOCUMENTINFORMATION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDocumentInformation.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDocumentInformation" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDOCUMENTINFORMATION ]

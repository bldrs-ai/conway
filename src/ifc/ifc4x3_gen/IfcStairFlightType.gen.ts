...
export  class IfcStairFlightType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTAIRFLIGHTTYPE
  }
  private PredefinedType_? : IfcStairFlightTypeEnum

  public get PredefinedType() : IfcStairFlightTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcStairFlightTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStairFlightType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStairFlightType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTAIRFLIGHTTYPE ]

...
export  class IfcConversionBasedUnitWithOffset extends IfcConversionBasedUnit {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONVERSIONBASEDUNITWITHOFFSET
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcConversionBasedUnitWithOffset.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcConversionBasedUnitWithOffset" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONVERSIONBASEDUNITWITHOFFSET ]

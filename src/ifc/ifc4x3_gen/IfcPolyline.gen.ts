...
export  class IfcPolyline extends IfcBoundedCurve {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPOLYLINE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPolyline.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPolyline" )
      }

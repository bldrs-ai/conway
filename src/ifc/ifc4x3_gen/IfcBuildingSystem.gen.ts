...
export  class IfcBuildingSystem extends IfcSystem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBUILDINGSYSTEM
  }
  ...
  public get PredefinedType() : IfcBuildingSystemTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 5, 5, 5, IfcBuildingSystemTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBuildingSystem.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBuildingSystem" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBUILDINGSYSTEM ]

...
export  class IfcBoxedHalfSpace extends IfcHalfSpaceSolid {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBOXEDHALFSPACE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBoxedHalfSpace.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBoxedHalfSpace" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBOXEDHALFSPACE ]

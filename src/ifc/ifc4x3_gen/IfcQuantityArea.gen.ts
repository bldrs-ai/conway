...
export  class IfcQuantityArea extends IfcPhysicalSimpleQuantity {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCQUANTITYAREA
  }
  ...
  public get AreaValue() : number {
    if ( this.AreaValue_ === void 0 ) {
      this.AreaValue_ = this.extractNumber( 3, 3, 2, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcQuantityArea.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcQuantityArea" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCQUANTITYAREA ]

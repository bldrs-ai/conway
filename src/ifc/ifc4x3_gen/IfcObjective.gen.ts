...
export  class IfcObjective extends IfcConstraint {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCOBJECTIVE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcObjective.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcObjective" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCOBJECTIVE ]

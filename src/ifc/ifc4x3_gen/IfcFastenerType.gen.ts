...
export  class IfcFastenerType extends IfcElementComponentType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFASTENERTYPE
  }
  private PredefinedType_? : IfcFastenerTypeEnum

  public get PredefinedType() : IfcFastenerTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcFastenerTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFastenerType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFastenerType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFASTENERTYPE ]

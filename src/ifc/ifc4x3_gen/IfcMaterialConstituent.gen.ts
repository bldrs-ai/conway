...
export  class IfcMaterialConstituent extends IfcMaterialDefinition {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMATERIALCONSTITUENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMaterialConstituent.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMaterialConstituent" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMATERIALCONSTITUENT ]

...
export  class IfcCurveStyleFontPattern extends IfcPresentationItem {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCURVESTYLEFONTPATTERN
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCurveStyleFontPattern.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCurveStyleFontPattern" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCURVESTYLEFONTPATTERN ]

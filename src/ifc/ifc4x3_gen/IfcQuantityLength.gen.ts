...
export  class IfcQuantityLength extends IfcPhysicalSimpleQuantity {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCQUANTITYLENGTH
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcQuantityLength.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcQuantityLength" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCQUANTITYLENGTH ]

...
export  class IfcMaterialLayerSetUsage extends IfcMaterialUsageDefinition {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMATERIALLAYERSETUSAGE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMaterialLayerSetUsage.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMaterialLayerSetUsage" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMATERIALLAYERSETUSAGE ]

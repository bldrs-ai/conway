...
export  class IfcRelDefinesByType extends IfcRelDefines {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELDEFINESBYTYPE
  }
  ...
  public get RelatingType() : IfcTypeObject {
    if ( this.RelatingType_ === void 0 ) {
      this.RelatingType_ = this.extractElement( 5, 4, 3, false, IfcTypeObject )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelDefinesByType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelDefinesByType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELDEFINESBYTYPE ]

...
export  class IfcCableCarrierSegment extends IfcFlowSegment {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCABLECARRIERSEGMENT
  }
  ...
  public get PredefinedType() : IfcCableCarrierSegmentTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcCableCarrierSegmentTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCableCarrierSegment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCableCarrierSegment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCABLECARRIERSEGMENT ]

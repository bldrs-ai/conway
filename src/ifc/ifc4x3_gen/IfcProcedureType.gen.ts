...
export  class IfcProcedureType extends IfcTypeProcess {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPROCEDURETYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcProcedureType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcProcedureType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROCEDURETYPE ]

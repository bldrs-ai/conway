...
export  class IfcCommunicationsAppliance extends IfcFlowTerminal {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCOMMUNICATIONSAPPLIANCE
  }
  ...
  public get PredefinedType() : IfcCommunicationsApplianceTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcCommunicationsApplianceTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCommunicationsAppliance.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCommunicationsAppliance" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCOMMUNICATIONSAPPLIANCE ]

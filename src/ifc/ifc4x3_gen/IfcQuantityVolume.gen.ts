...
export  class IfcQuantityVolume extends IfcPhysicalSimpleQuantity {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCQUANTITYVOLUME
  }
  ...
  public get VolumeValue() : number {
    if ( this.VolumeValue_ === void 0 ) {
      this.VolumeValue_ = this.extractNumber( 3, 3, 2, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcQuantityVolume.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcQuantityVolume" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCQUANTITYVOLUME ]

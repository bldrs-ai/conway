...
///**
// *  */
export abstract class IfcRepresentation extends StepEntityBase< EntityTypesIfc4x3 > {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCREPRESENTATION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRepresentation.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRepresentation" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSHAPEREPRESENTATION, EntityTypesIfc4x3.IFCTOPOLOGYREPRESENTATION, EntityTypesIfc4x3.IFCSTYLEDREPRESENTATION ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCREPRESENTATION
}

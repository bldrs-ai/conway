...
export  class IfcDiscreteAccessory extends IfcElementComponent {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDISCRETEACCESSORY
  }
  ...
  public get PredefinedType() : IfcDiscreteAccessoryTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcDiscreteAccessoryTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDiscreteAccessory.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDiscreteAccessory" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDISCRETEACCESSORY ]

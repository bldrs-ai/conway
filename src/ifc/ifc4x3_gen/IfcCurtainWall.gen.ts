...
export  class IfcCurtainWall extends IfcBuiltElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCURTAINWALL
  }
  private PredefinedType_? : IfcCurtainWallTypeEnum | null

  public get PredefinedType() : IfcCurtainWallTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcCurtainWallTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCurtainWall.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCurtainWall" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCURTAINWALL ]

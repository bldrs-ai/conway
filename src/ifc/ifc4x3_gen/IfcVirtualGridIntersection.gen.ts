...
///**
// *  */
export  class IfcVirtualGridIntersection extends StepEntityBase< EntityTypesIfc4x3 > {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCVIRTUALGRIDINTERSECTION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcVirtualGridIntersection.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcVirtualGridIntersection" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCVIRTUALGRIDINTERSECTION ]

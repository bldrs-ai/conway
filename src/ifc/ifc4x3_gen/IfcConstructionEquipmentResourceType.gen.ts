...
export  class IfcConstructionEquipmentResourceType extends IfcConstructionResourceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE
  }
  ...
  public get PredefinedType() : IfcConstructionEquipmentResourceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 11, 11, 5, IfcConstructionEquipmentResourceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcConstructionEquipmentResourceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcConstructionEquipmentResourceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE ]

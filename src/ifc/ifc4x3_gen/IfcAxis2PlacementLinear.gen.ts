...
export  class IfcAxis2PlacementLinear extends IfcPlacement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCAXIS2PLACEMENTLINEAR
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAxis2PlacementLinear.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAxis2PlacementLinear" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAXIS2PLACEMENTLINEAR ]

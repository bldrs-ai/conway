...
export  class IfcActuator extends IfcDistributionControlElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCACTUATOR
  }
  private PredefinedType_? : IfcActuatorTypeEnum | null

  public get PredefinedType() : IfcActuatorTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 7, IfcActuatorTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcActuator.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcActuator" )
      }

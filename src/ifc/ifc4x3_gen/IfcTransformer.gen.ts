...
export  class IfcTransformer extends IfcEnergyConversionDevice {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTRANSFORMER
  }
  private PredefinedType_? : IfcTransformerTypeEnum | null

  public get PredefinedType() : IfcTransformerTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 8, IfcTransformerTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTransformer.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTransformer" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTRANSFORMER ]

...
export  class IfcPropertyListValue extends IfcSimpleProperty {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPROPERTYLISTVALUE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPropertyListValue.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPropertyListValue" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROPERTYLISTVALUE ]

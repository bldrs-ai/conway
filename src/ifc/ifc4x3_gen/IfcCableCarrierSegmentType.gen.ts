...
export  class IfcCableCarrierSegmentType extends IfcFlowSegmentType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCABLECARRIERSEGMENTTYPE
  }
  private PredefinedType_? : IfcCableCarrierSegmentTypeEnum

  public get PredefinedType() : IfcCableCarrierSegmentTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcCableCarrierSegmentTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCableCarrierSegmentType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCableCarrierSegmentType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCABLECARRIERSEGMENTTYPE ]

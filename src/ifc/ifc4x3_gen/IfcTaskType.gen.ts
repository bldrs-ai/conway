...
export  class IfcTaskType extends IfcTypeProcess {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTASKTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTaskType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTaskType" )
      }

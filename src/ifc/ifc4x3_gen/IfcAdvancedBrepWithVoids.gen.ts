...
export  class IfcAdvancedBrepWithVoids extends IfcAdvancedBrep {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCADVANCEDBREPWITHVOIDS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAdvancedBrepWithVoids.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAdvancedBrepWithVoids" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCADVANCEDBREPWITHVOIDS ]

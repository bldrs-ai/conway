...
export  class IfcDoorLiningProperties extends IfcPreDefinedPropertySet {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDOORLININGPROPERTIES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDoorLiningProperties.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDoorLiningProperties" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDOORLININGPROPERTIES ]

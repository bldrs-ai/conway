...
export  class IfcQuantityNumber extends IfcPhysicalSimpleQuantity {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCQUANTITYNUMBER
  }
  private NumberValue_? : number
  private Formula_? : string | null

  public get NumberValue() : number {
    if ( this.NumberValue_ === void 0 ) {
      this.NumberValue_ = this.extractNumber( 3, 3, 2, false )
    }

    return this.NumberValue_ as number
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcQuantityNumber.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcQuantityNumber" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCQUANTITYNUMBER ]

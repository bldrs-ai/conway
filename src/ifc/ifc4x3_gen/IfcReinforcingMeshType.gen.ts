...
export  class IfcReinforcingMeshType extends IfcReinforcingElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCREINFORCINGMESHTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcReinforcingMeshType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcReinforcingMeshType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCREINFORCINGMESHTYPE ]

...
export  class IfcTextureMap extends IfcTextureCoordinate {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTEXTUREMAP
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTextureMap.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTextureMap" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTEXTUREMAP ]

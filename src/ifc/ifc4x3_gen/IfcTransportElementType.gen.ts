...
export  class IfcTransportElementType extends IfcTransportationDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTRANSPORTELEMENTTYPE
  }
  private PredefinedType_? : IfcTransportElementTypeEnum

  public get PredefinedType() : IfcTransportElementTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcTransportElementTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTransportElementType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTransportElementType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCTRANSPORTELEMENTTYPE ]

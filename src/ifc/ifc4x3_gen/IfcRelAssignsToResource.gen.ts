...
export  class IfcRelAssignsToResource extends IfcRelAssigns {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRELASSIGNSTORESOURCE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRelAssignsToResource.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRelAssignsToResource" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRELASSIGNSTORESOURCE ]

...
export  class IfcBuildingElementProxy extends IfcBuiltElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBUILDINGELEMENTPROXY
  }
  ...
  public get PredefinedType() : IfcBuildingElementProxyTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcBuildingElementProxyTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBuildingElementProxy.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBuildingElementProxy" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBUILDINGELEMENTPROXY ]

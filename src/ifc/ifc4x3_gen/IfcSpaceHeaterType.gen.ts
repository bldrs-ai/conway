...
export  class IfcSpaceHeaterType extends IfcFlowTerminalType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSPACEHEATERTYPE
  }
  private PredefinedType_? : IfcSpaceHeaterTypeEnum

  public get PredefinedType() : IfcSpaceHeaterTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcSpaceHeaterTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcSpaceHeaterType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcSpaceHeaterType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSPACEHEATERTYPE ]

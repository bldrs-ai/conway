...
export  class IfcOffsetCurve2D extends IfcOffsetCurve {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCOFFSETCURVE2D
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcOffsetCurve2D.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcOffsetCurve2D" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCOFFSETCURVE2D ]

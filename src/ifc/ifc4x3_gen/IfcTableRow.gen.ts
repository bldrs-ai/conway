...
///**
// *  */
export  class IfcTableRow extends StepEntityBase< EntityTypesIfc4x3 > {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCTABLEROW
  }
  ...
  public get IsHeading() : boolean | null {
    if ( this.IsHeading_ === void 0 ) {
      this.IsHeading_ = this.extractBoolean( 1, 0, 0, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcTableRow.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcTableRow" )
      }

...
export  class IfcCableSegmentType extends IfcFlowSegmentType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCABLESEGMENTTYPE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCableSegmentType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCableSegmentType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCABLESEGMENTTYPE ]

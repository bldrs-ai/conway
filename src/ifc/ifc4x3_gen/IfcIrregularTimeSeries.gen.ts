...
export  class IfcIrregularTimeSeries extends IfcTimeSeries {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCIRREGULARTIMESERIES
  }
  ...
  public get Values() : Array<IfcIrregularTimeSeriesValue> {
    if ( this.Values_ === void 0 ) {
      ...
      let   cursor    = this.getOffsetCursor( 8, 8, 1 )
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcIrregularTimeSeries.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcIrregularTimeSeries" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCIRREGULARTIMESERIES ]

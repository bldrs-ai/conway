...
export  class IfcPlateType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPLATETYPE
  }
  private PredefinedType_? : IfcPlateTypeEnum

  public get PredefinedType() : IfcPlateTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcPlateTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcPlateType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcPlateType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPLATETYPE ]

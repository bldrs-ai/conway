...
export  class IfcAxis1Placement extends IfcPlacement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCAXIS1PLACEMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAxis1Placement.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAxis1Placement" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAXIS1PLACEMENT ]

...
export abstract class IfcExtendedProperties extends IfcPropertyAbstraction {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCEXTENDEDPROPERTIES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcExtendedProperties.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcExtendedProperties" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMATERIALPROPERTIES, EntityTypesIfc4x3.IFCPROFILEPROPERTIES ]

  public static readonly expectedType: EntityTypesIfc4x3 =
    EntityTypesIfc4x3.IFCEXTENDEDPROPERTIES
}

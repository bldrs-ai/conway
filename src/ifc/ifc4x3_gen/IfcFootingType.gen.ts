...
export  class IfcFootingType extends IfcBuiltElementType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFOOTINGTYPE
  }
  private PredefinedType_? : IfcFootingTypeEnum

  public get PredefinedType() : IfcFootingTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 6, IfcFootingTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFootingType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFootingType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFOOTINGTYPE ]

...
///**
// *  */
export  class IfcIrregularTimeSeriesValue extends StepEntityBase< EntityTypesIfc4x3 > {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCIRREGULARTIMESERIESVALUE
  }
  ...
  public get TimeStamp() : string {
    if ( this.TimeStamp_ === void 0 ) {
      this.TimeStamp_ = this.extractString( 0, 0, 0, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcIrregularTimeSeriesValue.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcIrregularTimeSeriesValue" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCIRREGULARTIMESERIESVALUE ]

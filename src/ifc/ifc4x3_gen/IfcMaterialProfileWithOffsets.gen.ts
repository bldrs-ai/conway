...
export  class IfcMaterialProfileWithOffsets extends IfcMaterialProfile {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMATERIALPROFILEWITHOFFSETS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMaterialProfileWithOffsets.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMaterialProfileWithOffsets" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMATERIALPROFILEWITHOFFSETS ]

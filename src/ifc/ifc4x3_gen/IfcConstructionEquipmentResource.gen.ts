...
export  class IfcConstructionEquipmentResource extends IfcConstructionResource {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONSTRUCTIONEQUIPMENTRESOURCE
  }
  ...
  public get PredefinedType() : IfcConstructionEquipmentResourceTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 10, 10, 5, IfcConstructionEquipmentResourceTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcConstructionEquipmentResource.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcConstructionEquipmentResource" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONSTRUCTIONEQUIPMENTRESOURCE ]

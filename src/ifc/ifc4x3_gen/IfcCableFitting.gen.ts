...
export  class IfcCableFitting extends IfcFlowFitting {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCABLEFITTING
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCableFitting.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCableFitting" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCABLEFITTING ]

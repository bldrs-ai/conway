...
export  class IfcArbitraryProfileDefWithVoids extends IfcArbitraryClosedProfileDef {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCARBITRARYPROFILEDEFWITHVOIDS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcArbitraryProfileDefWithVoids.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcArbitraryProfileDefWithVoids" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCARBITRARYPROFILEDEFWITHVOIDS ]

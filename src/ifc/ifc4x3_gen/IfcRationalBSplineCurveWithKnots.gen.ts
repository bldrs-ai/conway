...
export  class IfcRationalBSplineCurveWithKnots extends IfcBSplineCurveWithKnots {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCRATIONALBSPLINECURVEWITHKNOTS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcRationalBSplineCurveWithKnots.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcRationalBSplineCurveWithKnots" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCRATIONALBSPLINECURVEWITHKNOTS ]

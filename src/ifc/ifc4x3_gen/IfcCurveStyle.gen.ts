...
export  class IfcCurveStyle extends IfcPresentationStyle {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCURVESTYLE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCurveStyle.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCurveStyle" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCURVESTYLE ]

...
export  class IfcConstructionMaterialResource extends IfcConstructionResource {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCONSTRUCTIONMATERIALRESOURCE
  }
  ...
  public get PredefinedType() : IfcConstructionMaterialResourceTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 10, 10, 5, IfcConstructionMaterialResourceTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcConstructionMaterialResource.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcConstructionMaterialResource" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCONSTRUCTIONMATERIALRESOURCE ]

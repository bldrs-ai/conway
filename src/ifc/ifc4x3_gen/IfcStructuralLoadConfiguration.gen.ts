...
export  class IfcStructuralLoadConfiguration extends IfcStructuralLoad {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCSTRUCTURALLOADCONFIGURATION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcStructuralLoadConfiguration.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcStructuralLoadConfiguration" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCSTRUCTURALLOADCONFIGURATION ]

...
export  class IfcCartesianPointList2D extends IfcCartesianPointList {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCCARTESIANPOINTLIST2D
  }
  private CoordList_? : Array< Array< number > >
  private TagList_? : Array< string > | null
  ...
  public get TagList() : Array< string > | null {
    if ( this.TagList_ === void 0 ) {
    ...
    return this.TagList_ as Array< string > | null
  }
  constructor(
    localID: number,
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcCartesianPointList2D.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcCartesianPointList2D" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCCARTESIANPOINTLIST2D ]

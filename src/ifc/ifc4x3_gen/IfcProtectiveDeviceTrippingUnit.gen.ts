...
export  class IfcProtectiveDeviceTrippingUnit extends IfcDistributionControlElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCPROTECTIVEDEVICETRIPPINGUNIT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcProtectiveDeviceTrippingUnit.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcProtectiveDeviceTrippingUnit" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCPROTECTIVEDEVICETRIPPINGUNIT ]

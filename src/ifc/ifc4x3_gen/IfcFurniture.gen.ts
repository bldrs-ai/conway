...
export  class IfcFurniture extends IfcFurnishingElement {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFURNITURE
  }
  private PredefinedType_? : IfcFurnitureTypeEnum | null

  public get PredefinedType() : IfcFurnitureTypeEnum | null {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 8, 8, 6, IfcFurnitureTypeEnumDeserializeStep, true )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFurniture.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFurniture" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFURNITURE ]

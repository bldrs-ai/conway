...
export  class IfcFacetedBrepWithVoids extends IfcFacetedBrep {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCFACETEDBREPWITHVOIDS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcFacetedBrepWithVoids.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcFacetedBrepWithVoids" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCFACETEDBREPWITHVOIDS ]

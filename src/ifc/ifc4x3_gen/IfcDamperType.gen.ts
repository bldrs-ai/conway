...
export  class IfcDamperType extends IfcFlowControllerType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCDAMPERTYPE
  }
  private PredefinedType_? : IfcDamperTypeEnum

  public get PredefinedType() : IfcDamperTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcDamperTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcDamperType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcDamperType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCDAMPERTYPE ]

...
export  class IfcAxis2Placement2D extends IfcPlacement {
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcAxis2Placement2D.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcAxis2Placement2D" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCAXIS2PLACEMENT2D ]

...
export  class IfcBurnerType extends IfcEnergyConversionDeviceType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCBURNERTYPE
  }
  private PredefinedType_? : IfcBurnerTypeEnum

  public get PredefinedType() : IfcBurnerTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcBurnerTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcBurnerType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcBurnerType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCBURNERTYPE ]

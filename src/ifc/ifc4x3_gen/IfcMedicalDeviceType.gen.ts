...
export  class IfcMedicalDeviceType extends IfcFlowTerminalType {
  public get type(): EntityTypesIfc4x3 {
    return EntityTypesIfc4x3.IFCMEDICALDEVICETYPE
  }
  private PredefinedType_? : IfcMedicalDeviceTypeEnum

  public get PredefinedType() : IfcMedicalDeviceTypeEnum {
    if ( this.PredefinedType_ === void 0 ) {
      this.PredefinedType_ = this.extractLambda( 9, 9, 8, IfcMedicalDeviceTypeEnumDeserializeStep, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === IfcMedicalDeviceType.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for IfcMedicalDeviceType" )
      }
  ...
  public static readonly query = 
    [ EntityTypesIfc4x3.IFCMEDICALDEVICETYPE ]

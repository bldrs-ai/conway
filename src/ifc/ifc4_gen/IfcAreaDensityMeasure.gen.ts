...
export class IfcAreaDensityMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCAREADENSITYMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCAREADENSITYMEASURE ]

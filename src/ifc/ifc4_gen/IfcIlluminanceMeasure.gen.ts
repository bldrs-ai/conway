...
export class IfcIlluminanceMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCILLUMINANCEMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCILLUMINANCEMEASURE ]

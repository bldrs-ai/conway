...
export class IfcPositivePlaneAngleMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCPOSITIVEPLANEANGLEMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCPOSITIVEPLANEANGLEMEASURE ]

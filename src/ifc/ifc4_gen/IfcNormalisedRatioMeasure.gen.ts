...
export class IfcNormalisedRatioMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCNORMALISEDRATIOMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCNORMALISEDRATIOMEASURE ]

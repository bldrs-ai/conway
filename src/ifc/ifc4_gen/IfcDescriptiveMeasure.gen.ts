...
export class IfcDescriptiveMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCDESCRIPTIVEMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCDESCRIPTIVEMEASURE ]

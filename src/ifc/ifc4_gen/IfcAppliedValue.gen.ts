...
export  class IfcAppliedValue extends StepEntityBase< EntityTypesIfc > {
  ...
  public static readonly query = 
    [ EntityTypesIfc.IFCAPPLIEDVALUE, EntityTypesIfc.IFCCOSTVALUE ]

  public static readonly expectedType: EntityTypesIfc =
    EntityTypesIfc.IFCAPPLIEDVALUE
}

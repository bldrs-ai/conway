...
export  class IfcFlowTerminal extends IfcDistributionFlowElement {
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCFLOWTERMINAL
  }

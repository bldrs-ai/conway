...
export class IfcLinearForceMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCLINEARFORCEMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCLINEARFORCEMEASURE ]

...
export class IfcMassDensityMeasure extends StepEntityBase< EntityTypesIfc > {    
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.IFCMASSDENSITYMEASURE
  }
  ...
  public static readonly query =
    [ EntityTypesIfc.IFCMASSDENSITYMEASURE ]

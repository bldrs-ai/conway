...
export  class face extends topological_representation_item {
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === face.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for face" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.FACE, EntityTypesAP214.FACE_SURFACE, EntityTypesAP214.SUBFACE, EntityTypesAP214.ORIENTED_FACE ]

  public static readonly expectedType: EntityTypesAP214 =
    EntityTypesAP214.FACE
}

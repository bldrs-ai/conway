...
export  class applied_date_and_time_assignment extends date_and_time_assignment {
  ...
  public get items() : Array<action | action_directive | action_method | action_property | action_relationship | action_request_solution | alternate_product_relationship | applied_action_assignment | applied_classification_assignment | applied_organization_assignment | applied_person_and_organization_assignment | approval_person_organization | approval_status | assembly_component_usage_substitute | certification | class_ | class_system | configuration_design | configuration_item | configured_effectivity_assignment | contract | document_file | draughting_model | drawing_revision | effectivity | event_occurrence | executed_action | general_property | material_designation | mechanical_design_geometric_presentation_representation | organization_relationship | organizational_project | person_and_organization | presentation_area | product | product_concept | product_concept_feature | product_concept_feature_association | product_concept_feature_category | product_concept_feature_category_usage | product_definition | product_definition_formation | product_definition_formation_relationship | product_definition_relationship | product_definition_substitute | property_definition | requirement_for_action_resource | resource_property | security_classification | security_classification_level | shape_representation | versioned_action_request> {
    if ( this.items_ === void 0 ) {
      ...
      const value : Array<action | action_directive | action_method | action_property | action_relationship | action_request_solution | alternate_product_relationship | applied_action_assignment | applied_classification_assignment | applied_organization_assignment | applied_person_and_organization_assignment | approval_person_organization | approval_status | assembly_component_usage_substitute | certification | class_ | class_system | configuration_design | configuration_item | configured_effectivity_assignment | contract | document_file | draughting_model | drawing_revision | effectivity | event_occurrence | executed_action | general_property | material_designation | mechanical_design_geometric_presentation_representation | organization_relationship | organizational_project | person_and_organization | presentation_area | product | product_concept | product_concept_feature | product_concept_feature_association | product_concept_feature_category | product_concept_feature_category_usage | product_definition | product_definition_formation | product_definition_formation_relationship | product_definition_relationship | product_definition_substitute | property_definition | requirement_for_action_resource | resource_property | security_classification | security_classification_level | shape_representation | versioned_action_request> = []
    ...
    return this.items_ as Array<action | action_directive | action_method | action_property | action_relationship | action_request_solution | alternate_product_relationship | applied_action_assignment | applied_classification_assignment | applied_organization_assignment | applied_person_and_organization_assignment | approval_person_organization | approval_status | assembly_component_usage_substitute | certification | class_ | class_system | configuration_design | configuration_item | configured_effectivity_assignment | contract | document_file | draughting_model | drawing_revision | effectivity | event_occurrence | executed_action | general_property | material_designation | mechanical_design_geometric_presentation_representation | organization_relationship | organizational_project | person_and_organization | presentation_area | product | product_concept | product_concept_feature | product_concept_feature_association | product_concept_feature_category | product_concept_feature_category_usage | product_definition | product_definition_formation | product_definition_formation_relationship | product_definition_relationship | product_definition_substitute | property_definition | requirement_for_action_resource | resource_property | security_classification | security_classification_level | shape_representation | versioned_action_request>
  }
  constructor(
    localID: number,
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === applied_date_and_time_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for applied_date_and_time_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.APPLIED_DATE_AND_TIME_ASSIGNMENT ]

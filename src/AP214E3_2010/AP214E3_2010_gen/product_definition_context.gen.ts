...
export  class product_definition_context extends application_context_element {
  ...
  public get life_cycle_stage() : string {
    if ( this.life_cycle_stage_ === void 0 ) {
      this.life_cycle_stage_ = this.extractString( 2, 2, 1, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === product_definition_context.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for product_definition_context" )
      }

...
export  class surface_style_silhouette extends founded_item {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.SURFACE_STYLE_SILHOUETTE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === surface_style_silhouette.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for surface_style_silhouette" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.SURFACE_STYLE_SILHOUETTE ]

...
export  class versioned_action_request extends StepEntityBase< EntityTypesAP214 > {
  ...
  public get purpose() : string {
    if ( this.purpose_ === void 0 ) {
      this.purpose_ = this.extractString( 2, 0, 0, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === versioned_action_request.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for versioned_action_request" )
      }

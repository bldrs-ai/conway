...
export  class product_specification extends product_identification {
  ...
  public get item_concept_feature() : Array<product_concept_feature_association> {
    if ( this.item_concept_feature_ === void 0 ) {
      ...
      let   cursor    = this.getOffsetCursor( 5, 5, 2 )
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === product_specification.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for product_specification" )
      }

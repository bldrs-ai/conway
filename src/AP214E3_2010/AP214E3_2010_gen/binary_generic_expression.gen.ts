...
///**
// *  */
export abstract class binary_generic_expression extends generic_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.BINARY_GENERIC_EXPRESSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === binary_generic_expression.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for binary_generic_expression" )
      }
  ...
  public static readonly expectedType: EntityTypesAP214 =
    EntityTypesAP214.BINARY_GENERIC_EXPRESSION
}

...
export  class externally_defined_dimension_definition extends dimensional_size {
  ...
  public get source() : external_source {
    if ( this.source_ === void 0 ) {
      this.source_ = this.extractElement( 3, 2, 1, false, external_source )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === externally_defined_dimension_definition.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for externally_defined_dimension_definition" )
      }

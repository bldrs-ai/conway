...
export  class boolean_literal extends simple_boolean_expression {
  ...
  public get the_value() : boolean {
    if ( this.the_value_ === void 0 ) {
      this.the_value_ = this.extractBoolean( 0, 0, 4, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === boolean_literal.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for boolean_literal" )
      }

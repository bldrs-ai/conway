...
export  class concat_expression extends string_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.CONCAT_EXPRESSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === concat_expression.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for concat_expression" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.CONCAT_EXPRESSION ]

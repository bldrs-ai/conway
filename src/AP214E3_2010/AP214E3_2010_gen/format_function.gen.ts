...
///**
// *  */
export  class format_function extends string_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.FORMAT_FUNCTION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === format_function.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for format_function" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.FORMAT_FUNCTION ]

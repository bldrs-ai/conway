...
export  class externally_defined_class extends class_ {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.EXTERNALLY_DEFINED_CLASS
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === externally_defined_class.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for externally_defined_class" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.EXTERNALLY_DEFINED_CLASS ]

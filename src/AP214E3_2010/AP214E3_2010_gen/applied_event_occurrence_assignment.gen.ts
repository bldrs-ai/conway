...
export  class applied_event_occurrence_assignment extends event_occurrence_assignment {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.APPLIED_EVENT_OCCURRENCE_ASSIGNMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === applied_event_occurrence_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for applied_event_occurrence_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.APPLIED_EVENT_OCCURRENCE_ASSIGNMENT ]

...
export  class composite_text_with_associated_curves extends composite_text {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.COMPOSITE_TEXT_WITH_ASSOCIATED_CURVES
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === composite_text_with_associated_curves.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for composite_text_with_associated_curves" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.COMPOSITE_TEXT_WITH_ASSOCIATED_CURVES ]

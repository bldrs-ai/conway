...
export  class uncertainty_assigned_representation extends representation {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.UNCERTAINTY_ASSIGNED_REPRESENTATION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === uncertainty_assigned_representation.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for uncertainty_assigned_representation" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.UNCERTAINTY_ASSIGNED_REPRESENTATION ]

...
export  class revolute_pair_range extends simple_pair_range {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.REVOLUTE_PAIR_RANGE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === revolute_pair_range.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for revolute_pair_range" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.REVOLUTE_PAIR_RANGE ]

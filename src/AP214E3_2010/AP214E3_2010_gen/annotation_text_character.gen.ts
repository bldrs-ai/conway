...
export  class annotation_text_character extends mapped_item {
  ...
  public get alignment() : string {
    if ( this.alignment_ === void 0 ) {
      this.alignment_ = this.extractString( 3, 3, 2, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === annotation_text_character.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for annotation_text_character" )
      }

...
///**
// *  */
export  class applied_date_assignment extends date_assignment {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.APPLIED_DATE_ASSIGNMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === applied_date_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for applied_date_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.APPLIED_DATE_ASSIGNMENT ]

...
export  class applied_certification_assignment extends certification_assignment {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.APPLIED_CERTIFICATION_ASSIGNMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === applied_certification_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for applied_certification_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.APPLIED_CERTIFICATION_ASSIGNMENT ]

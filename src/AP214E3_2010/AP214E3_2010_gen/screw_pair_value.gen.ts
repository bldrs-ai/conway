...
export  class screw_pair_value extends pair_value {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.SCREW_PAIR_VALUE
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === screw_pair_value.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for screw_pair_value" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.SCREW_PAIR_VALUE ]

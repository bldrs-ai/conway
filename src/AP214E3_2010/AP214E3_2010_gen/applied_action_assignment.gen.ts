...
export  class applied_action_assignment extends action_assignment {
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === applied_action_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for applied_action_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.APPLIED_ACTION_ASSIGNMENT ]

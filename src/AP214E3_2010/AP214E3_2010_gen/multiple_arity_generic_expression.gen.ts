...
///**
// *  */
export abstract class multiple_arity_generic_expression extends generic_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.MULTIPLE_ARITY_GENERIC_EXPRESSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === multiple_arity_generic_expression.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for multiple_arity_generic_expression" )
      }
  ...
  public static readonly expectedType: EntityTypesAP214 =
    EntityTypesAP214.MULTIPLE_ARITY_GENERIC_EXPRESSION
}

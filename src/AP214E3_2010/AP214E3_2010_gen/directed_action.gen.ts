...
export  class directed_action extends executed_action {
  ...
  public get directive() : action_directive {
    if ( this.directive_ === void 0 ) {
      this.directive_ = this.extractElement( 3, 3, 2, false, action_directive )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === directed_action.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for directed_action" )
      }

  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === exclusive_product_concept_feature_category.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for exclusive_product_concept_feature_category" )
      }

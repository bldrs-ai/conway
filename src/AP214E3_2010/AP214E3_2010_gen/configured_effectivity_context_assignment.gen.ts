...
export  class configured_effectivity_context_assignment extends effectivity_context_assignment {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.CONFIGURED_EFFECTIVITY_CONTEXT_ASSIGNMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === configured_effectivity_context_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for configured_effectivity_context_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.CONFIGURED_EFFECTIVITY_CONTEXT_ASSIGNMENT ]

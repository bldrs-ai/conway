...
///**
// *  */
export  class interpolated_configuration_sequence extends StepEntityBase< EntityTypesAP214 > {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.INTERPOLATED_CONFIGURATION_SEQUENCE
  }
  private interpolation_? : Array<configuration_interpolation>
  ...
  public get interpolation() : Array<configuration_interpolation> {
    if ( this.interpolation_ === void 0 ) {
      ...
      while ( signedCursor0 >= 0 ) {
        const value1 = this.extractBufferElement( buffer, cursor, endCursor, configuration_interpolation )
        if ( value1 === void 0 ) {
    ...
    return this.interpolation_ as Array<configuration_interpolation>
  }
  constructor(
    localID: number,
  ...
  public static readonly query = 
    [ EntityTypesAP214.INTERPOLATED_CONFIGURATION_SEQUENCE ]

...
export  class product_context extends application_context_element {
  ...
  public get discipline_type() : string {
    if ( this.discipline_type_ === void 0 ) {
      this.discipline_type_ = this.extractString( 2, 2, 1, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === product_context.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for product_context" )
      }

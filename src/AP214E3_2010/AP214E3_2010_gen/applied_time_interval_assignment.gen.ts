...
///**
// *  */
export  class applied_time_interval_assignment extends time_interval_assignment {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.APPLIED_TIME_INTERVAL_ASSIGNMENT
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === applied_time_interval_assignment.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for applied_time_interval_assignment" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.APPLIED_TIME_INTERVAL_ASSIGNMENT ]

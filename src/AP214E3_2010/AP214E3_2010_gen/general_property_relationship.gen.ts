...
export  class general_property_relationship extends StepEntityBase< EntityTypesAP214 > {
  ...
  public get relating_property() : general_property {
    if ( this.relating_property_ === void 0 ) {
      this.relating_property_ = this.extractElement( 2, 0, 0, false, general_property )
    }
  ...
  public get related_property() : general_property {
    if ( this.related_property_ === void 0 ) {
      this.related_property_ = this.extractElement( 3, 0, 0, false, general_property )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === general_property_relationship.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for general_property_relationship" )
      }

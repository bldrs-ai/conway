...
export abstract class multiple_arity_numeric_expression extends numeric_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.MULTIPLE_ARITY_NUMERIC_EXPRESSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === multiple_arity_numeric_expression.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for multiple_arity_numeric_expression" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.PLUS_EXPRESSION, EntityTypesAP214.MULT_EXPRESSION, EntityTypesAP214.MAXIMUM_FUNCTION, EntityTypesAP214.MINIMUM_FUNCTION ]

  public static readonly expectedType: EntityTypesAP214 =
    EntityTypesAP214.MULTIPLE_ARITY_NUMERIC_EXPRESSION
}

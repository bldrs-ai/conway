...
export  class drawing_sheet_revision_usage extends area_in_set {
  ...
  public get sheet_number() : string {
    if ( this.sheet_number_ === void 0 ) {
      this.sheet_number_ = this.extractString( 2, 2, 1, false )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === drawing_sheet_revision_usage.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for drawing_sheet_revision_usage" )
      }

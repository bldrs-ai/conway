...
///**
// *  */
export abstract class binary_boolean_expression extends boolean_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.BINARY_BOOLEAN_EXPRESSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === binary_boolean_expression.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for binary_boolean_expression" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.XOR_EXPRESSION, EntityTypesAP214.EQUALS_EXPRESSION ]

  public static readonly expectedType: EntityTypesAP214 =
    EntityTypesAP214.BINARY_BOOLEAN_EXPRESSION
}

...
export  class text_literal_with_blanking_box extends text_literal {
  ...
  public get blanking() : planar_box {
    if ( this.blanking_ === void 0 ) {
      this.blanking_ = this.extractElement( 6, 6, 3, false, planar_box )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === text_literal_with_blanking_box.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for text_literal_with_blanking_box" )
      }

...
export  class brep_with_voids extends manifold_solid_brep {
  ...
  public get voids() : Array<oriented_closed_shell> {
    if ( this.voids_ === void 0 ) {
      ...
      while ( signedCursor0 >= 0 ) {
        const value1 = this.extractBufferElement( buffer, cursor, endCursor, oriented_closed_shell )
        if ( value1 === void 0 ) {
    ...
    return this.voids_ as Array<oriented_closed_shell>
  }
  constructor(
    localID: number,
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === brep_with_voids.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for brep_with_voids" )
      }

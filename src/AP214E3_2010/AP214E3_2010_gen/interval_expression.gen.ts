...
///**
// *  */
export  class interval_expression extends boolean_expression {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.INTERVAL_EXPRESSION
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === interval_expression.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for interval_expression" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.INTERVAL_EXPRESSION ]

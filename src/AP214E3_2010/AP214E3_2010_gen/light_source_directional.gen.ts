...
export  class light_source_directional extends light_source {
  ...
  public get orientation() : direction {
    if ( this.orientation_ === void 0 ) {
      this.orientation_ = this.extractElement( 2, 2, 3, false, direction )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === light_source_directional.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for light_source_directional" )
      }

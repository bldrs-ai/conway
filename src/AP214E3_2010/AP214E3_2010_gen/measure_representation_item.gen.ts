...
export  class measure_representation_item extends representation_item {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.MEASURE_REPRESENTATION_ITEM
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === measure_representation_item.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for measure_representation_item" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.MEASURE_REPRESENTATION_ITEM ]

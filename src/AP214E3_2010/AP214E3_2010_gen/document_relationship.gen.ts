...
export  class document_relationship extends StepEntityBase< EntityTypesAP214 > {
  ...
  public get relating_document() : document {
    if ( this.relating_document_ === void 0 ) {
      this.relating_document_ = this.extractElement( 2, 0, 0, false, document )
    }
  ...
  public get related_document() : document {
    if ( this.related_document_ === void 0 ) {
      this.related_document_ = this.extractElement( 3, 0, 0, false, document )
    }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === document_relationship.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for document_relationship" )
      }

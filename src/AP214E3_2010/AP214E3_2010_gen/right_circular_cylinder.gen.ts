...
export  class right_circular_cylinder extends geometric_representation_item {
  public get type(): EntityTypesAP214 {
    return EntityTypesAP214.RIGHT_CIRCULAR_CYLINDER
  }
  ...
  constructor(
    ...
    if ( multiReference !== void 0 ) {
      ...
      const localReference =
        multiReference.find( ( item ) => item.typeID === right_circular_cylinder.expectedType )

      if ( localReference === void 0 ) {
        throw new Error( "Couldn't find multi-element reference for right_circular_cylinder" )
      }
  ...
  public static readonly query = 
    [ EntityTypesAP214.RIGHT_CIRCULAR_CYLINDER ]
